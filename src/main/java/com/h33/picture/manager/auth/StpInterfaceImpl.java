package com.h33.picture.manager.auth;
...
import com.h33.picture.model.enums.SpaceRoleEnum;
import com.h33.picture.model.enums.SpaceTypeEnum;
...
import static com.h33.picture.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (loginUser == null) {
            throw new BusinessException(ErrorCode.NOT_AUTH_ERROE, "用户未登录");
        }
